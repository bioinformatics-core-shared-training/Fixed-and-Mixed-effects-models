...
An experimenter investigating the effect of different food for a species of fish places the food in tanks containing the fish. The weight increase of the fish is the response (y<sub>ijy</sub>), where i,j and k are indices identifying the fish, the tank and the type of food, respectively.
...
|$\mu$|=|$\beta$<sub>0</sub>|+|$\beta$x<sub>1</sub><sup>(1/2)</sup>|+|0|+|0|+|0|+|$\beta$<sub>5</sub>x<sub>5</sub>|
|||||||||||||
